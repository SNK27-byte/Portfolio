...
// véritfication de l'envoie du formulaire
if(isset($_POST['nom']))
{
    ...
    // si un test se passe mal, on midifie la variable $err avec un nombre (permet le débug)
    ...
    if($err == 0)
    {
        ...
        $insert->execute([$nom]);
        //redirection vers la page categories avec indication du succès
