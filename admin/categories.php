<?php
    ...
    if(isset($_GET['delete']) && is_numeric($_GET['delete'])) {
        ...
        $products = $bdd->prepare("SELECT * FROM oeuvres WHERE id=?");
        $products->execute([$id]);
        ...
        $delProd = $bdd->prepare("DELETE FROM oeuvres WHERE id=?");
        $delProd->execute([$id]);
...
<body>
    ...
    <div class="container-fluid">
        ...
        <?php
            ...
            {
                echo "<div class='alert alert-warning'>Vous avez bien modifié la catégorie n°".$_GET['update']."à la base de donnée</div>";
            }
        ?>
